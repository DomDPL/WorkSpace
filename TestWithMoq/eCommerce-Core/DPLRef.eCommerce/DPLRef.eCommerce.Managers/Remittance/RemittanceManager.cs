...
{
    internal class RemittanceManager : ManagerBase, BackOffice.IBackOfficeRemittanceManager,
        Admin.IAdminRemittanceManager
    {
            ...
            try
            {
                ...
                if (UtilityFactory.CreateUtility<ISecurityUtility>().SellerAuthenticated())
                {
                    var sellerSalesTotals = AccessorFactory.CreateAccessor<IOrderAccessor>()
                        .SalesTotal();
                    return sellerSalesTotals != null
                        ? new Admin.SalesTotalsResponse
                        {
                            Success = true,

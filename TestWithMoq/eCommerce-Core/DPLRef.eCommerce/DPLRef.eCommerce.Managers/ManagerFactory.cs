...
using DPLRef.eCommerce.Managers.Catalog;
...
namespace DPLRef.eCommerce.Managers
{
    public class ManagerFactory : FactoryBase
    {
        ...
        public ManagerFactory(AmbientContext context, EngineFactory engineFactory = null,
            AccessorFactory accessorFactory = null, UtilityFactory utilityFactory = null)
            : base(context)
        {
            ...
            AddType<IWebStoreCatalogManager>(typeof(CatalogManager));
            AddType<IAdminCatalogManager>(typeof(CatalogManager));

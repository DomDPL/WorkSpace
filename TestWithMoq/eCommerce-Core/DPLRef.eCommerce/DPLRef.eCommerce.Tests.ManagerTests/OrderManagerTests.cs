...
namespace DPLRef.eCommerce.Tests.ManagerTests
{
    ...
    public class OrderManagerTests : ManagerTestBase
    {
        ...
        private readonly PaymentInstrument _goodPayment = new()
        {
        ...
        private readonly PaymentInstrument _badPayment = new()
        {
        ...
        private UtilityFactory SetupMockUtilityFactory()
        {
            ...
            var utilFactory = new UtilityFactory(new AmbientContext());
        ...
        private IWebStoreOrderManager GetWebStoreManager(Guid sessionId)
        {
            ...
            return mgrFactory.CreateManager<IWebStoreOrderManager>(null, SetupMockAccessorFactory(),

...
namespace DPLRef.eCommerce.Tests.ManagerTests
{
    ...
    public class CartManagerTests : ManagerTestBase
    {
        ...
        private readonly WebStoreCart _billingInfoCart = new()
        {
            ...
            TaxAmount = 0.0m,
            Total = 0.0m,
            CartItems = Array.Empty<WebStoreCartItem>()
        };

        private readonly WebStoreCart _shippingInfoCart = new()
        {
            Id = MockData.MySessionId,
            BillingAddress = null,
        ...
        private readonly WebStoreCart _bothInfoCart = new()
        {
            Id = MockData.MySessionId,
        ...
        {
            var accFactory = new AccessorFactory(mockData.Context, new UtilityFactory(new AmbientContext()));
            ...
            accFactory.AddOverride<ICatalogAccessor>(mockCatalogAccessor);
        ...
        {
            var engFactory = new EngineFactory(mockData.Context, SetupMockAccessorFactory(), null);
            return engFactory;
        }
        ...
        private IWebStoreCartManager GetWebStoreManager(Guid sessionId)
        {
            ...
            return mgrFactory.CreateManager<IWebStoreCartManager>(SetupMockEngineFactory(), SetupMockAccessorFactory(),
                null);
        }
        ...
        public void CartManager_SaveCartItem()
        {
            ...
            _ = mgr.UpdateBillingInfo(1, _myAddress, true);
        ...
        public void CartManager_UpdateBillingInfoBoth()
        {
            ...
            _ = mgr.UpdateShippingInfo(CatalogId, _mySameAddress, true);
        ...
        public void CartManager_UpdateShippingInfoBoth()
        {
            ...
            _ = mgr.UpdateBillingInfo(CatalogId, _mySameAddress, false);

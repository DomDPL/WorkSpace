...
namespace DPLRef.eCommerce.Tests.ManagerTests
{
    ...
    public class RemittanceManagerTests
    {
        ...
        private BackOffice.IBackOfficeRemittanceManager GetBackOfficeManager()
        {
            ...
            return mgrFactory.CreateManager<BackOffice.IBackOfficeRemittanceManager>(null, SetupMockAccessorFactory(),
        ...
        {
            var mgrFactory = new ManagerFactory(mockData.Context);
            return mgrFactory.CreateManager<Admin.IAdminRemittanceManager>(null, SetupMockAccessorFactory(),
                SetupMockUtilityFactory());
        }

...
namespace DPLRef.eCommerce.Common.Shared
{
    public static class Config
    {
        ...
        public static string SqlServerConnectionString => GetConfigValue("eCommerceDatabase");
        ...
        public static bool IsSqlServer => string.IsNullOrEmpty(SqlServerConnectionString);

        public static string QueuePath => GetConfigValue("eCommerceQueuePath", "Queue");

        public static string IndexPath => GetConfigValue("eCommerceIndexPath", "SearchIndex");
        ...
        private static string GetStartDir()
        {
            ...
            var dirPath = location.Substring(0,
                location.IndexOf(sourceStart, StringComparison.Ordinal) + sourceStart.Length);

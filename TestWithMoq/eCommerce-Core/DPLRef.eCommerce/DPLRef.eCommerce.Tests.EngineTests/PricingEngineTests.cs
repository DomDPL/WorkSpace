...
namespace DPLRef.eCommerce.Tests.EngineTests
{
    ...
    {
        private readonly Guid _mySessionId = new("aaaaaaaa-bbbb-cccc-dddd-eeeeeeeeeeee");
        ...
        public void PricingEngine_GenerateCartPricingInvalidProducId()
        {
            ...
            var _ = pricingEngine.GenerateCartPricing(storedCart);
        }
        ...
        {
            var engFactory = new EngineFactory(mockData.Context, null, null);
        ...
        {
            var mockAccessor = new MockCatalogAccessor(mockData);

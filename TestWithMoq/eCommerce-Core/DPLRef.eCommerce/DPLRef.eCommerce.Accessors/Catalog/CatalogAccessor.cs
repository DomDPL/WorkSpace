...
{
    internal class CatalogAccessor : AccessorBase, ICatalogAccessor
    {
        ...
        public void DeleteCatalog(int id)
        {
            ...
            if (model != null &&
                model.SellerId == Context.SellerId) // make sure the seller context matches the model seller
            {
                _ = db.Catalogs.Remove(model);
                _ = db.SaveChanges();
            }
            else
            {
        ...
        public void DeleteProduct(int catalogId, int id)
        {
            ...
            if (model != null &&
                model.CatalogId == catalogId) // make sure the Catalog context matches the model Catalog
            {
                _ = db.Products.Remove(model);
                _ = db.SaveChanges();
            }
            else
            {

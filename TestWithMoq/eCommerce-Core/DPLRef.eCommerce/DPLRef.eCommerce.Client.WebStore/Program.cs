...
namespace DPLRef.eCommerce.Client.WebStore
{
    public class Program
    {
        ...
        private static readonly Address _billingAddress = new()
        {
        ...
        private static readonly Address _shippingAddress = new()
        {
            Addr1 = "151 N 8th Street",
            Addr2 = "",
            City = "Lincoln",
        ...
        private static readonly PaymentInstrument PaymentInstrument = new()
        {
        ...
        private static void ShowCatalog(int catalogId)
        {
            ...
            ShowResponse(response, StringUtilities.DataContractToJson(response.Catalog));
        }
        ...
        private static void ShowProductDetail(int catalogId, int productId)
        {
            ...
            ShowResponse(response, StringUtilities.DataContractToJson(response.Product));
        }
        ...
        private static void AddItemToCart(int productId, int quantity, Guid sessionId)
        {
            ...
            ShowResponse(response, StringUtilities.DataContractToJson(response.Cart));
        }
        ...
        private static void SubmitOrder(Guid sessionId)
        {
            ...
            ShowResponse(response, StringUtilities.DataContractToJson(response.Order));
        }
    }
}
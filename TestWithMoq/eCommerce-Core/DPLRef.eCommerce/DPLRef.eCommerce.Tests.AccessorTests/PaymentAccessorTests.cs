...
namespace DPLRef.eCommerce.Tests.AccessorTests
{
    ...
    {
        private IPaymentAccessor CreatePaymentAccessor()
        {
        ...
        public void PaymentAccessor_AuthSuccess()
        {
            ...
            var result =
                accessor.Authorize(
                    ...
                    {
                        AccountNumber = "4012888888881881", VerificationCode = 123, ExpirationDate = "2019-01-01",
        ...
        public void PaymentAccessor_AuthFail()
        {
            ...
            var result =
                accessor.Authorize(
                    new PaymentInstrument
                    {
                        AccountNumber = "5012888888881881", VerificationCode = 123, ExpirationDate = "2019-01-01",
                        PaymentType = PaymentTypes.CreditCard
                    }, 1, 100.00M);
            Assert.IsNotNull(result);

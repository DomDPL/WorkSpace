...
namespace DPLRef.eCommerce.Tests.AccessorTests
{
    ...
    public class OrderAccessorTests : DbTestAccessorBase
    {
        ...
        public void OrderAccessor_Submit_Error_NoOrderLines()
        {
            ...
            var accessor = CreateOrderAccessor();
            var _ = accessor.SaveOrder(2, order);
        }
        ...
        {
            var accessor = CreateOrderAccessor();
            var _ = accessor.SaveOrder(2, null);
        }
        ...
        {
            _ = CreateUnfulfilledOrderObject();

            var accessor = CreateOrderAccessor();

            // set the order id to 0 to cause exception
            _ = accessor.UpdateOrderStatus(0, OrderStatuses.Captured, "");
        }
        ...
        public void OrderAccessor_UpdateOrderStatusNullOrder()
        {
            ...
            _ = accessor.UpdateOrderStatus(999999999, OrderStatuses.Captured, "");
        }
        ...
        public void OrderAccessor_FulfillOrderNullOrder()
        {
            ...
            _ = accessor.FulfillOrder(999999999, "", "", "");
        }
        ...
        private static Address ShippingAddress => BillingAddress;

        private static Order CreateUnfulfilledOrderObject() => new()
        {
            BillingAddress = BillingAddress,
            ShippingAddress = ShippingAddress,
            OrderLines = new[]

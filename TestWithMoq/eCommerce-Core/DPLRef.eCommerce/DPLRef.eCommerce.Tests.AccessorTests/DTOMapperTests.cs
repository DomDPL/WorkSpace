...
namespace DPLRef.eCommerce.Tests.AccessorTests
{
    ...
    public class DTOMapperTests
    {
        ...
        public void DTOMapper_IsDTOMapperConfigValid() => DTOMapper.Configuration.AssertConfigurationIsValid();
        ...
        public void DTOMapper_CartMap_1()
        {
            ...
            var result = DTOMapper.Map<Accessors.DataTransferObjects.Cart>(input);
        ...
        {
            var input = new Accessors.DataTransferObjects.Cart
            {

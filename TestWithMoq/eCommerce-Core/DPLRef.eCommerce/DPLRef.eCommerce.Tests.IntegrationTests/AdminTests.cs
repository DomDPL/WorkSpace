...
namespace DPLref.eCommerce.Tests.IntegrationTests
{
    ...
    public class AdminTests : IntegrationTestBase
    {
        ...
        public void Admin_FindCatalogs()
        {
            ...
            var expectedJson = StringUtilities.DataContractToJson(AdminResponses.FindCatalogsResponse);
        ...
        public void Admin_FindCatalogsNoAuth()
        {
            ...
            var response = adminCatalogManager.FindCatalogs();
            var responseJson = StringUtilities.DataContractToJson(response);
            var expectedJson = StringUtilities.DataContractToJson(AdminResponses.FindCatalogsNoAuthResponse);
        ...
        public void Admin_ShowCatalog()
        {
            ...
            var responseJson = StringUtilities.DataContractToJson(response);
            var expectedJson = StringUtilities.DataContractToJson(AdminResponses.CatalogResponse);
        ...
        public void Admin_ShowCatalogNotFound()
        {
            ...
            var response = adminCatalogManager.ShowCatalog(-1);
            var responseJson = StringUtilities.DataContractToJson(response);
            var expectedJson = StringUtilities.DataContractToJson(AdminResponses.CatalogNotFoundResponse);
        ...
        public void Admin_ShowCatalogNoAuth()
        {
            ...
            var response = adminCatalogManager.ShowCatalog(1);
            var responseJson = StringUtilities.DataContractToJson(response);
            var expectedJson = StringUtilities.DataContractToJson(AdminResponses.CatalogNoAuthResponse);
        ...
        public void Admin_ShowProduct()
        {
            ...
            var responseJson = StringUtilities.DataContractToJson(response);
            var expectedJson = StringUtilities.DataContractToJson(AdminResponses.ProductResponse);
        ...
        public void Admin_ShowProductNotFound()
        {
            ...
            var responseJson = StringUtilities.DataContractToJson(response);
            var expectedJson = StringUtilities.DataContractToJson(AdminResponses.ProductNotFoundResponse);
        ...
        public void Admin_ShowProductNoAuth()
        {
            ...
            var response = webStoreCatalogManager.ShowProduct(1, 1);
            var responseJson = StringUtilities.DataContractToJson(response);
            var expectedJson = StringUtilities.DataContractToJson(AdminResponses.ProductNoAuthResponse);

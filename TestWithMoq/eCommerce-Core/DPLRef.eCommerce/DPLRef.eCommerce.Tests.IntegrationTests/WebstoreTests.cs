...
namespace DPLref.eCommerce.Tests.IntegrationTests
{
    ...
    public class WebstoreTests : IntegrationTestBase
    {
        ...
        private static readonly Address _myAddress = new()
        {
        ...
        private static readonly Address _mySameAddress = new()
        {
        ...
        private readonly MockData mockData = new()
        {
        ...
        private T GetManager<T>(AmbientContext context) where T : class
        {
            ...
            var utilFactory = new UtilityFactory(context);
        ...
        public void Webstore_ShowCatalogNotFound()
        {
            ...
            var webStoreCatalogManager = GetManager<IWebStoreCatalogManager>(context);
            var response = webStoreCatalogManager.ShowCatalog(-1);
            var responseJson = StringUtilities.DataContractToJson(response);
            var expectedJson = StringUtilities.DataContractToJson(WebstoreResponses.CatalogNotFoundResponse);
        ...
        public void Webstore_ShowProduct()
        {
            ...
            var responseJson = StringUtilities.DataContractToJson(response);
            var expectedJson = StringUtilities.DataContractToJson(WebstoreResponses.ProductResponse);
        ...
        public void Webstore_ShowProductNotFound()
        {
            ...
            var responseJson = StringUtilities.DataContractToJson(response);
            var expectedJson = StringUtilities.DataContractToJson(WebstoreResponses.ProductNotFoundResponse);
        ...
        public void Webstore_SaveCartItem()
        {
            ...
            _ = webStoreCartManager.UpdateBillingInfo(1, _myAddress, false);
            _ = webStoreCartManager.UpdateShippingInfo(1, _myAddress, false);
        ...
        public void Webstore_SaveCartItemInvalidCatalog()
        {
            var context = new AmbientContext
                {SellerId = 1, SessionId = Guid.NewGuid()}; // Catalog Id 0 does not own Product Id 1
            var webStoreCartManager = GetManager<IWebStoreCartManager>(context);
        ...
        public void Webstore_ShowCart()
        {
            ...
            Assert.AreEqual(StringUtilities.DataContractToJson(createdCart),
                StringUtilities.DataContractToJson(response));
        }
        ...
        public void Webstore_ShowCartInvalidCatalog()
        {
            ...
            var context = new AmbientContext {SellerId = 1, SessionId = Guid.NewGuid()};
            var webStoreCartManager = GetManager<IWebStoreCartManager>(context);
            _ = webStoreCartManager.SaveCartItem(1, 1, 2);
        ...
        public void Webstore_UpdateBillingInfo()
        {
            ...
            Assert.AreEqual(StringUtilities.DataContractToJson(_myAddress),
                StringUtilities.DataContractToJson(response.Cart.BillingAddress));
            Assert.AreEqual(StringUtilities.DataContractToJson(new Address()),
                StringUtilities.DataContractToJson(response.Cart.ShippingAddress));
            Assert.AreEqual(0, response.Cart.CartItems.Length);
        ...
        public void Webstore_UpdateBillingInfoBoth()
        {
            ...
            Assert.IsNull(response.Message);
            Assert.AreEqual(context.SessionId, response.Cart.Id);
            Assert.AreEqual(StringUtilities.DataContractToJson(_mySameAddress),
                StringUtilities.DataContractToJson(response.Cart.BillingAddress));
            Assert.AreEqual(StringUtilities.DataContractToJson(_mySameAddress),
                StringUtilities.DataContractToJson(response.Cart.ShippingAddress));
            Assert.AreEqual(0, response.Cart.CartItems.Length);

...
## Mac Notes
    ...
    using macOS v10.15 (Catalina) or newer you need to update the .zshrc
    can view file by running command in terminal
    
    `touch ~/.zprofile; open ~/.zprofile`
    
    then paste connection informaion into .zprofile file and save file.
